...
#SBATCH --job-name=ae_s_s_128_6_adv_color_mem

 # Standard out and Standard Error output files
#SBATCH --output=./slurm/ae_s_s_128_comp_6_adv_color_mem.out
#SBATCH --error=./slurm/ae_s_s_128_mse_6_adv_color_mem.err
...
python ae.py init --enc_type shallow --dec_type shallow --hidden_size 128 --batch_size 16 --recons_loss comp_6_adv_color --img_res 64 --dataset tiny-imagenet --num_epochs 50 --output_folder trash