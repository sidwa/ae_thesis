...
#SBATCH --job-name=vae_shallow_shallow_128_mse

 # Standard out and Standard Error output files
#SBATCH --output=./slurm/vae_shallow_shallow_128_mse.out
#SBATCH --error=./slurm/vae_shallow_shallow_128_mse.err
...
python vae.py init --enc_type shallow --dec_type shallow --hidden_size 128 --batch_size 64 --device cuda:0 --num_epoch 40 --dataset tiny-imagenet --recons_loss mse --img_res 64 --num_epoch 40