...
#SBATCH --job-name=acai_shallow_shallow_128_mse

 # Standard out and Standard Error output files
#SBATCH --output=./slurm/acai_shallow_shallow_128_mse.out
#SBATCH --error=./slurm/acai_shallow_shallow_128_mse.err
...
python acai.py init --enc_type shallow --dec_type shallow --hidden_size 128 --batch_size 32 --img_res 64 --device cuda:0 --dataset imagenet --recons_loss mse --num_epochs 20