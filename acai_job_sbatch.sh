...
##SBATCH --job-name=acai_shallow_shallow_128_gan

 # Standard out and Standard Error output files
##SBATCH --output=./slurm/acai_shallow_shallow_128_gan.out
##SBATCH --error=./slurm/acai_shallow_shallow_128_gan.err
...
#
python acai.py $1 --enc_type $2 --dec_type $3 --hidden_size $4 --batch_size $5 --recons_loss $6 --dataset $7 --img_res $8 --num_epochs $9
#python acai.py --enc_type shallow --dec_type shallow --hidden_size 128 --batch_size 232 --device cuda:0 --data_folder ../datasets/ImageNet --recons_loss gan